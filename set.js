...
global.footer = "*Created by Zuka*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~oIO0e9mcDUcJehoizz5Q", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "263789544743", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Zuka", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "Zuka", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "Zuka💜", // Added // Input Yours custom...
